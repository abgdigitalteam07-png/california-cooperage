...
export const PRODUCTS: Record<ProductKey, Product> = {
  cr1: {
    ...
    specs: [
      { label: 'Model Code', value: 'CR1' },
      { label: 'Seating Capacity', value: '5 Persons' },
      { label: 'Shape', value: 'Rectangular' },
      { label: 'Dimensions (L × W × H)', value: '68″ × 59″ × 30″ (173 × 150 × 76 cm)' },
    ...
    features: [
      ...
      { icon: '⛨', title: 'California Heritage', body: 'Manufactured to California Cooperage standards — built on 50+ years of California hot tub heritage since 1972.' },
    ],
    faqs: [
      { q: 'What is the exact footprint of the CR1?', a: 'The CR1 measures 68″ × 59″ × 30″ (approximately 173 × 150 × 76 cm). Its rectangular footprint makes it an excellent fit for narrower deck spaces or patios where a square model won\'t fit.' },
  ...
  cr2: {
    ...
    specs: [
      ...
      { label: 'Dry Weight', value: '~972 lbs (441 kg)' },
      { label: 'Filled Weight', value: '~2,425 lbs (1,100 kg)' },
    ...
    features: [
      ...
      { icon: '⛨', title: 'Built to California Standards', body: 'The culmination of 50+ years of California Cooperage quality — built on the original California hot tub heritage since 1972.' },
    ],
    faqs: [
      { q: 'How much does the CR2 weigh when filled?', a: 'The CR2 weighs approximately 972 lbs (441 kg) dry and approximately 2,425 lbs (1,100 kg) filled. Ensure your deck or patio can support this load before installation — consult a structural engineer or contractor. Your dealer can advise on site preparation.' },
  ...
  cr3: {
    ...
    specs: [
      ...
      { label: 'Dimensions (⌀ × H)', value: '⌀81″ × 32″ (⌀205 × 81 cm)' },
    ...
    features: [
      ...
      { icon: '⛨', title: '50 Years of Heritage', body: 'Built on California Cooperage\'s 50+ year hot tub heritage since 1972 — the original California hot tub brand.' },
    ],
    faqs: [
      { q: 'What is the exact diameter of the CR3?', a: 'The CR3 has a diameter of approximately 81″ (205 cm) and is 32″ (81 cm) deep. Its circular footprint is comparable in area to the CR2\'s 81″ × 81″ square, making it suitable for most standard patio and deck installations.' },
