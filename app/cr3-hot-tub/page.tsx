...
export const metadata: Metadata = {
  ...
  description: "The CR3 is California Cooperage's 6-person round rotomold spa — 21 jets, Balboa controls, 3KW heater, ⌀81″ × 32″ circular footprint. The most social spa in the lineup.",
